...
if has("spell")
  ...
  if g:gruvbox_improved_warnings == 0
    call s:HL('SpellCap',   s:green, s:none, s:undercurl, s:red)
  else
  ...
  call s:HL('SpellLocal', s:yellow, s:none, s:undercurl, s:aqua)
  " Rare word
  call s:HL('SpellRare',  s:blue, s:none, s:undercurl, s:purple)
endif
